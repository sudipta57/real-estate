...
const ContactUs = () => {
  return (
    <div className="min-h-screen flex flex-col lg:flex-row max-w-7xl mx-auto my-10 justify-between ">
      {/* Form Section */}
      <div className="lg:w-1/2 bg-white p-10 flex flex-col justify-center border-[#D9D9D9] border rounded-md shadow-md">
        ...
        <form className="mt-8 space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <input
              ...
              className="w-full p-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 bg-[#F4F4F4]"
            />
            <input
              type="text"
              placeholder="Enter your name"
          ...
          <textarea
            ...
            className="w-full p-3 border rounded-md h-32 resize-none focus:outline-none focus:ring-2 focus:ring-orange-500 bg-[#F4F4F4]"
          ></textarea>
          <button
            type="submit"
      ...
      {/* Map Section */}
      <div className="lg:w-1/2 h-96 lg:h-auto px-4 rounded-e-lg">
        <iframe
          title="Google Map"
